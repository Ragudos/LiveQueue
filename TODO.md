...
- [x] Webhook to receive updates
- [x] SSE sender after receiving Webhook event
- [x] Frontend to display new received data
...
- [ ] Toast and Push-On Notifications
- [ ] Estimation of when a specific ticket numebr will be accommodated
